...
parser.add_argument("-lossdata", "--lossdata_path", type=str, default="LINEImplementation/loss_data.pkl")
...
parser.add_argument("-batchsize", "--batchsize", type=int, default=64)
